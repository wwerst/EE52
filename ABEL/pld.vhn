...
GLB_BUF_977 : PGBUFI_dram
    GENERIC MAP (TRISE => 1.600000 ns, TFALL => 1.600000 ns)
	PORT MAP (Z0 => BUF_977, A0 => B6_X2O);
GLB_B6_IN10 : PGBUFI_dram
    GENERIC MAP (TRISE => 1.100000 ns, TFALL => 1.100000 ns)
...
GRP_OR_925_iomux : PGBUFI_dram
    GENERIC MAP (TRISE => 1.000000 ns, TFALL => 1.000000 ns)
	PORT MAP (Z0 => OR_925_iomux, A0 => OR_925);
GRP_DEF_924_iomux : PGBUFI_dram
    GENERIC MAP (TRISE => 1.000000 ns, TFALL => 1.000000 ns)
	PORT MAP (Z0 => DEF_924_iomux, A0 => DEF_924);
GRP_AND_922_iomux : PGBUFI_dram
    GENERIC MAP (TRISE => 1.000000 ns, TFALL => 1.000000 ns)
...
GRP_BUF_976_part2_ck1f : PGBUFI_dram
    GENERIC MAP (TRISE => 1.800000 ns, TFALL => 1.800000 ns)
...
GRP_BUF_976_part1_iock1f : PGBUFI_dram
    GENERIC MAP (TRISE => 1.800000 ns, TFALL => 1.800000 ns)
